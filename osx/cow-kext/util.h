...
static inline void *GENC_OVERLOADABLE genc_container_of_helper(void *obj,
                                                               ptrdiff_t
                                                               offset)
{
...
static inline const void *GENC_OVERLOADABLE genc_container_of_helper(const
                                                                     void
                                                                     *obj,
                                                                     ptrdiff_t
                                                                     offset)
{
    return (obj ? ((const char *) obj - offset) : NULL);
        ...
        /* function for avoiding multiple evaluation */
static inline const void *GENC_OVERLOADABLE
genc_container_of_notnull_helper(const void *obj, ptrdiff_t offset)
{
    return ((const char *) obj - offset);
}

static inline void *GENC_OVERLOADABLE genc_container_of_notnull_helper(void
                                                                       *obj,
                                                                       ptrdiff_t
                                                                       offset)
{
...
#else
        /* function for avoiding multiple evaluation */
static GENC_INLINE void *genc_container_of_helper(void *obj,
                                                  ptrdiff_t offset)
{
    return (obj ? ((char *) obj - offset) : NULL);
}
        ...
        /* function for avoiding multiple evaluation */
static GENC_INLINE void *genc_container_of_notnull_helper(void *obj,
                                                          ptrdiff_t offset)
{
    return ((char *) obj - offset);
}
        ...
        /* function for avoiding multiple evaluation */
static GENC_INLINE const void *genc_container_of_const_helper(const void
                                                              *obj,
                                                              ptrdiff_t
                                                              offset)
{
    return (obj ? ((const char *) obj - offset) : NULL);
        ...
        /* function for avoiding multiple evaluation */
static GENC_INLINE const void *genc_container_of_const_notnull_helper(const
                                                                      void
                                                                      *obj,
                                                                      ptrdiff_t
                                                                      offset)
