...
#ifdef NDEBUG
#if !defined(__UXEN__) || defined(__x86_64__)
#define WRAP_MASK (0xFFFFFFFFU)
#else  /* !defined(__UXEN__) || defined(__x86_64__) */
#define WRAP_MASK (PGC_count_mask)
#endif  /* !defined(__UXEN__) || defined(__x86_64__) */
#else
