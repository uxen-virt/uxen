...
#define PTSRC_lapic  2 /* LAPIC time source */
    ...
    u64 time_done;              /* total time converted to pending/injected interrupts */
    u64 period;                 /* frequency in ns */
    u64 schedule_period;        /* schedule frequency in ns (!= period for coalesced timers) */
    s_time_t scheduled;         /* scheduled timer interrupt */
    s_time_t scheduled_t0;      /* first schedule time */
...
void update_periodic_time(
    struct periodic_time *pt, int irq, uint64_t period,
    int leftover_ticks);
...
void rtc_init_timers(struct domain *d);
