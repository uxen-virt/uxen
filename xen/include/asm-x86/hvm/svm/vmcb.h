...
/*
 * Fill G_PAT with WB entries, so guest caching attributes can be
 * overriden in the nested page tables.
 *
 * See AMD64 Archtecture Programmer's Manual Volume 2, Table 15-19.
 */
#define VMCB_DEFAULT_G_PAT          0x0606060606060606ULL
