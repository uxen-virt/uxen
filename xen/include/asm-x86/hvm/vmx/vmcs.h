...
extern void vmx_unload_vmcs(struct vcpu *);
...
enum {
    VMCS_DIRTY_BIT_IO_BITMAP_A,
    VMCS_DIRTY_BIT_IO_BITMAP_A_HIGH,
    VMCS_DIRTY_BIT_IO_BITMAP_B,
    VMCS_DIRTY_BIT_IO_BITMAP_B_HIGH,
    VMCS_DIRTY_BIT_MSR_BITMAP,
    VMCS_DIRTY_BIT_MSR_BITMAP_HIGH,
    VMCS_DIRTY_BIT_TSC_OFFSET,
    VMCS_DIRTY_BIT_TSC_OFFSET_HIGH,
    VMCS_DIRTY_BIT_VIRTUAL_APIC_PAGE_ADDR,
    VMCS_DIRTY_BIT_VIRTUAL_APIC_PAGE_ADDR_HIGH,
    VMCS_DIRTY_BIT_EPT_POINTER,
    VMCS_DIRTY_BIT_EPT_POINTER_HIGH,
    VMCS_DIRTY_BIT_VMCS_LINK_POINTER,
    VMCS_DIRTY_BIT_VMCS_LINK_POINTER_HIGH,
    VMCS_DIRTY_BIT_GUEST_PDPTR0,
    VMCS_DIRTY_BIT_GUEST_PDPTR0_HIGH,
    VMCS_DIRTY_BIT_GUEST_PDPTR1,
    VMCS_DIRTY_BIT_GUEST_PDPTR1_HIGH,
    VMCS_DIRTY_BIT_GUEST_PDPTR2,
    VMCS_DIRTY_BIT_GUEST_PDPTR2_HIGH,
    VMCS_DIRTY_BIT_GUEST_PDPTR3,
    VMCS_DIRTY_BIT_GUEST_PDPTR3_HIGH,
};

#define VMCS_DIRTY_BIT(f) (1 << VMCS_DIRTY_BIT_ ## f)
