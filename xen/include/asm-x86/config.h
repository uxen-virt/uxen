...
// #define CONFIG_X86_EMUL_PERFC 1
...
#define MAX_HVM_VCPUS MAX_VIRT_CPUS /* max 128 */
 ...
 * arch/x86/x86_64/entry.S. However stubs in arch/x86/hvm/vmx/entry.S will
 * perform function calls using the MS ABI if __MS_ABI__ is defined. In this
 * case, functions called from there must be declared using asmlinkage_abi.
 */
#if defined(__MS_ABI__)
#define asmlinkage_abi __attribute__ ((__ms_abi__))
#define asmlinkage_sysv
#define asmlinkage
#elif defined (__SYSV_ABI__)
#define asmlinkage_abi
#define asmlinkage_sysv
#define asmlinkage
#else
...
#define asmlinkage_abi asmlinkage
#define asmlinkage_sysv asmlinkage
#else
#error No ABI defined
#endif
