...
/* Host allocator */
extern struct page_list_head host_page_list;
extern spinlock_t host_page_list_lock;
void init_host_pages(void);
void *alloc_host_pages(unsigned int pages, unsigned int memflags);
...
#define  MEMF_multiok     (1U<<_MEMF_multiok)
#define _MEMF_node        8
