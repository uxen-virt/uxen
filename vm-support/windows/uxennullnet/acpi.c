...
acpi_get_mac_address(IN PDEVICE_OBJECT pdo, UCHAR *mac_address)
{
    ...
    ACPI_EVAL_OUTPUT_BUFFER *output_buffer =
        (ACPI_EVAL_OUTPUT_BUFFER *) output_buffer_buf;
    NTSTATUS status;
    ...
    input_buffer.MethodNameAsUlong = (ULONG)('CAMV');
    ...
    status = SendDownStreamIrp(pdo,
                               ...
                               output_buffer, sizeof(output_buffer_buf)
        );
