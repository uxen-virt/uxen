...
#define perfcnt_inc(id)
#define perfcnt_dec(id)
#define perfcnt_add(id, v)
#define perfcnt_sub(id, v)
#define perfcnt_set(id, v)
#define perfcnt_get(id)
#define perfcnt_inc_if(id, e)
#define perfcnt_dec_if(id, e)
#define perfcnt_add_if(id, v, e)
#define perfcnt_sub_if(id, v, e)
#define perfcnt_set_if(id, v, e)
#define perfcnt_set_max(id, v)
#define perfcnt_arr_inc(id, aid)
#define perfcnt_arr_dec(id, aid)
#define perfcnt_arr_add(id, aid, v)
