...
#define DLL_NAME                L"uxendispdd" // Name of the DLL in UNICODE
#define STANDARD_DEBUG_PREFIX   "UXENDISP: "  // All debug output is prefixed
#define ALLOC_TAG               'uxDD'        // Four byte tag (characters in
