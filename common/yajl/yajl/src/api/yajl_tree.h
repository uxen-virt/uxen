...
YAJL_API yajl_val yajl_tree_new_array (void);
YAJL_API yajl_val yajl_tree_new_integer(long long integer);
YAJL_API yajl_val yajl_tree_new_number(const unsigned char *number,
                                       size_t number_length);
YAJL_API yajl_val yajl_tree_new_string(const unsigned char *string,
                                       size_t string_length);
YAJL_API yajl_val yajl_tree_new_boolean (int boolean_value);
YAJL_API yajl_val yajl_tree_new_null (void);

YAJL_API int yajl_tree_set(yajl_val n, const char ** path, yajl_val value);

YAJL_API yajl_val yajl_tree_new_object(void);

YAJL_API int yajl_tree_array_add_value(yajl_val array, yajl_val value);
