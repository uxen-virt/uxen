...
struct display_state *display_state = NULL;
...
{
    struct display_state *ds = (struct display_state *)opaque;
...
void
free_displaysurface(struct display_surface *surface)
{
...
struct display_surface *
resize_displaysurface(struct display_surface *surface, int width, int height)
{
    if (surface)
...
void
dpy_refresh(struct display_state *s)
{
...
void
dpy_cursor(struct display_state *s, int x, int y)
{
...
void
dpy_cursor_shape(struct display_state *s,
