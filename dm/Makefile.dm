...
$(OSX_NOT_YET)cuckoo.o: CFLAGS_debug := $(subst $(CFLAG_OPTIMIZE_DEFAULT),$(CFLAG_OPTIMIZE_HIGH),$(CFLAGS_debug))
$(OSX_NOT_YET)cuckoo.o: CFLAGS_debug := $(subst $(CFLAG_OPTIMIZE_DEBUG),$(CFLAG_OPTIMIZE_DEFAULT),$(CFLAGS_debug))
...
$(WINDOWS)DM_SRCS += atto-agent.c
atto-agent.o: CPPFLAGS += $(LIBXC_CPPFLAGS)
atto-agent.o: CPPFLAGS += $(LIBUXENCTL_CPPFLAGS)
$(WINDOWS)DM_SRCS += atto-vm.c
...
DM_SRCS += vm-savefile-simple.c
vm-savefile-simple.o: CPPFLAGS += $(LIBXC_CPPFLAGS)
vm-savefile-simple.o: CPPFLAGS += $(LIBUXENCTL_CPPFLAGS)
vm-savefile-simple.o: CPPFLAGS += $(CUCKOO_CPPFLAGS)
...
$(WINDOWS)DM_SRCS += hw/pv_vblank.c
hw_pv_vblank.o: CPPFLAGS += $(LIBXC_CPPFLAGS)
hw_pv_vblank.o: CPPFLAGS += $(LIBUXENCTL_CPPFLAGS)
DM_SRCS += hw/uxen_fb.c
hw_uxen_fb.o: CPPFLAGS += -I$(XENPUBLICDIR)
...
$(WINDOWS)NICKEL_SRCS += http/ntlm.c
...
DM_OBJS += $(LZ4_OBJS)
lz4_lz4.o: CFLAGS_debug := $(subst $(CFLAG_OPTIMIZE_DEFAULT),$(CFLAG_OPTIMIZE_HIGH),$(CFLAGS_debug))
lz4_lz4.o: CFLAGS_debug := $(subst $(CFLAG_OPTIMIZE_DEBUG),$(CFLAG_OPTIMIZE_DEFAULT),$(CFLAGS_debug))

CUCKOO_OBJS = $(patsubst %.m,%.o,$(patsubst %.c,%.o,$(CUCKOO_SRCS)))
CUCKOO_OBJS := $(subst /,_,$(patsubst %,cuckoo/%,$(CUCKOO_OBJS)))
DM_OBJS += $(CUCKOO_OBJS)
cuckoo_fingerprint.o: CFLAGS_debug := $(subst $(CFLAG_OPTIMIZE_DEFAULT),$(CFLAG_OPTIMIZE_HIGH),$(CFLAGS_debug))
cuckoo_fingerprint.o: CFLAGS_debug := $(subst $(CFLAG_OPTIMIZE_DEBUG),$(CFLAG_OPTIMIZE_HIGH),$(CFLAGS_debug))

SWAP_OBJS = $(patsubst %.m,%.o,$(patsubst %.c,%.o,$(SWAP_SRCS)))
SWAP_OBJS := $(subst /,_,$(SWAP_OBJS))
$(SWAP_OBJS): CFLAGS_debug := $(subst $(CFLAG_OPTIMIZE_DEFAULT),$(CFLAG_OPTIMIZE_HIGH),$(CFLAGS_debug))
$(SWAP_OBJS): CFLAGS_debug := $(subst $(CFLAG_OPTIMIZE_DEBUG),$(CFLAG_OPTIMIZE_DEFAULT),$(CFLAGS_debug))
